...
module.exports = {
  ...
  goodsGet: (id) => {//商品查询
    return request('/weixin/api/ma/goodsspu/id?id=' + id+'&whereType=0', 'get', null, false)
  },
  ...
  phoneInfoGet: (data) => {//手机号获取接口
    return request('/wxphone', 'get', data, true)
  },
  // 验光模块接口
  optometryListByOpenid: (openid) => {
    return request('/weixin/api/optometry/getList', 'get', { openid }, false)
  },
  optometryDetail: (optometryRecordsId) => {
    return request(`/weixin/api/optometry/${optometryRecordsId}`, 'get', null, false)
  },
  optometryDataListById: (optometryRecordsId) => {
    return request('/weixin/api/optometry/list/ById', 'get', { optometryRecordsId }, false)
  },
  optometryHeadByIdT2: (optometryRecordsId) => {
    return request('/weixin/api/optometry/list/ById/t2', 'get', { optometryRecordsId }, false)
  },
  optometryFinalByIdT3: (optometryRecordsId) => {
    return request('/weixin/api/optometry/list/ById/t3', 'get', { optometryRecordsId }, false)
  },
  optometryByOptometryRecordsId: (optometryRecordsId) => {
    return request('/weixin/api/optometry/list/ByOptometryRecordsId', 'get', { optometryRecordsId }, false)
  }
}