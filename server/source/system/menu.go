...
func (i *initMenu) InitializeData(ctx context.Context) (next context.Context, err error) {
	...
	childMenus := []SysBaseMenu{
		...
		// 门店管理子菜单
		{MenuLevel: 1, Hidden: false, ParentId: menuNameMap["store"], Path: "storeManager", Name: "storeManager", Component: "view/store/storeManager.vue", Sort: 1, Meta: Meta{Title: "门店信息", Icon: "office-building"}},
