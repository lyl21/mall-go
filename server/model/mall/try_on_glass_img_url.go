...
// TryOnGlassImgUrl 试戴眼镜图片地址
type TryOnGlassImgUrl struct {
	Id         string     `json:"id" gorm:"column:id;primaryKey;type:varchar(32);comment:主键ID"`
	WxUserId   string     `json:"wxUserId" gorm:"column:wx_user_id;type:varchar(32);comment:微信用户ID"`
...
func (TryOnGlassImgUrl) TableName() string { return "try_on_glass_img_url" }
